...
Class CustomService{
     ...
     * @date   2017-04-25
     * 
     * @param  string     $tousername 用户openid
     * @param  string     $mediaId    素材id
     * 
     * @return array
     */
    public static function sendImage($tousername, $mediaId, $appid = '') {

        $appid = $appid ?: PFT_WECHAT_APPID;
        $queryUrl = 'https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token='.OpenAccessToken::getAccessToken($appid);
     ...
     * @return [type]                 
     */
    public static function sendText($tousername, $text, $appid = '') {
