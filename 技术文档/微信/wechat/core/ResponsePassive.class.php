...
class ResponsePassive{
     ...
     * @return string     <FuncFlag>%s</FuncFlag>
...
XML;
        ...
        return sprintf($template, $fromusername, $tousername, time(), $title, $description, $musicUrl, $hqMusicUrl, $thumbMediaId);
    }
