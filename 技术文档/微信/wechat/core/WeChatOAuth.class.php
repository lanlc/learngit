...
class WeChatOAuth{
     ...
     * @param null $component_appid 开放平台APPID
     */
    public static function getCode($redirect_uri, $state=1, $scope='snsapi_base', $component_appid=null){
        if($redirect_uri[0] == '/'){
...
//        $redirect_uri = urlencode($redirect_uri);
        ...
        $url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='
            ...
            . (!is_null($component_appid) ? "&component_appid={$component_appid}" : '')
            .'#wechat_redirect';
//        echo $url;exit;
