...
class UserManage{
    ...
    public static function getUserInfo($openId,$accessToken=null){
        //获取ACCESS_TOKEN
        $accessToken = is_null($accessToken) ? AccessToken::getAccessToken() : $accessToken;
        $queryUrl = 'https://api.weixin.qq.com/cgi-bin/user/info?lang=zh_CN&access_token='.$accessToken.'&openid='.$openId;
        $result =  Curl::callWebServer($queryUrl, '', 'GET');
