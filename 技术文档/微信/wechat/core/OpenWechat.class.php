...
use Library\wechat\core\Aes\OpenWechatRequest;
...
class OpenWechat{
     ...
     */
    public function __construct($token, $debug = FALSE, $xml) {
        //未通过消息真假性验证
    ...
    public function run() {
        if(strtolower($_SERVER['REQUEST_METHOD']) == 'get') {
            ...
            return OpenWechatRequest::switchType($this->request);
        }
    }
    ...
    public function checkSignature()
    {
        ...
        if( $tmpStr == $signature ){
//            $sql_update = "UPDATE pft_wx SET isconnect=0 WHERE id='".WECHAT_HASH."' LIMIT 1";
