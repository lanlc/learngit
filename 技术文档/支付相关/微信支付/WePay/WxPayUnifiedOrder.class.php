...
class WxPayUnifiedOrder extends WxPayDataBase
{
     ...
     * @param $sub_openid
     */
    public function SetSub_openid($sub_openid) {
        $this->values['sub_openid'] = $sub_openid;
    }
    ...
    {
        return array_key_exists('openid', $this->values) || array_key_exists('sub_openid', $this->values);
    }
}